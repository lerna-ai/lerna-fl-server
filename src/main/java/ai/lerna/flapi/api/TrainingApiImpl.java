...
public class TrainingApiImpl implements TrainingApi {
	...
	@Override
	public void postDeviceWeights(String token, TrainingWeightsRequest trainingWeightsRequest) throws Exception {
		validator.tokenValidation(token);
		flManager.saveDeviceWeights(token, trainingWeightsRequest);
	}
